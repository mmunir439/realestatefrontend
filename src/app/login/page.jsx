        ...
        <form className="space-y-5 text-black" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-md px-3 py-2 pr-14 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <button
              type="button"
