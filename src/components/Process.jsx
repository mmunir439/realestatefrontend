  ...
  <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
    ...
    <div className="text-gray-800 text-sm md:text-base leading-relaxed">
      <p>
        ...
        Islamabad, Faisal Town, Faisal Hills plots for sale, and associated
        projects, connect with Rana Waseem via WhatsApp at 03218661039. As the
        primary contact for support and transactions, Rana Waseem is known for his
        integrity, expertise, and commitment to ensuring every investment is
        handled with transparency and professionalism. Whether you&apos;re looking
        to buy, sell, or gather more information about properties like Faisal Hills
        D Block, Faisal Residencia, Multi Garden Phase 2, or Faisal Jewel, you can
      ...
      <p className="mt-4">
        ...
        the real estate market. Reach out today to experience hassle-free support
        and secure dealings that set the foundation for a prosperous future.
      </p>
    </div>
  </div>
</section>
